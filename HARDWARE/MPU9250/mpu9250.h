...
extern S_INT16_XYZ		GYRO_OFFSET;			//零漂
extern S_INT16_XYZ Gy_SET;//校准
extern S_INT16_XYZ Acc ; //加速度
extern S_INT16_XYZ Gyro; //陀螺仪
extern S_INT16_XYZ Mag;
extern S_INT16_XYZ Mag_Fuse;
extern FloatAngle  Angle;//欧拉角
extern FloatAngle  Angle_OFFSET;
extern FloatAngle  GYRO_Offset;
extern FloatAngle  ACC_Offset;
extern FloatAngle  Angle_SET;//欧拉角
extern IMU_DATA IMU_DAT;
